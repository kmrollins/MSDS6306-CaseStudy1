...
kable(hd, row.names=FALSE, caption="Table 1: Beginning of Merged Data Frame") %>% kable_styling()

# Display end of merged data frame 
# Hide ID fields, not necessary for client to see
tl <- select(tail(beer_data), -Brew_ID, -Beer_ID) # Hide ID fields
kable(tl, row.names=FALSE, caption="Table 2: End of Merged Data Frame") %>% kable_styling()
```
